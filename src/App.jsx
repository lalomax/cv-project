          ...
          <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4 ">
              ...
              <div class="bg-white shadow rounded-lg mt-6 p-6">
                ...
                <ul>
                  {data.languages.map((language) => {
                    return <li class="mb-2">{language}</li>;
                  })}
                </ul>
              </div>
            </div>
            ...
            <div class="col-span-4 sm:col-span-9 grid gap-6">
              <div class="bg-white shadow rounded-lg p-6">
                ...
                <p class="text-gray-700">{data.about} </p>
                ...
                <div class="flex justify-center items-center gap-6 my-6">
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path fill="currentColor" d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"></path>
                    </svg>
                  </a>
                </div>
                {/* Experience section */}
                  ...
                  return (
                    <div class="mb-6">
                      <div class="flex justify-between flex-wrap gap-2 w-full">
                        <span class="text-gray-700 font-bold">{jobs.Role}</span>
                        <p>
                          <span class="text-gray-700 mr-2">
                            at {jobs.Company}
                          </span>
                          <span class="text-gray-700">{jobs.time}</span>
                        </p>
                      </div>
              ...
              <div class="bg-white shadow rounded-lg p-6">
                ...
                {data.education.map((college) => {
                  return (
                    <div class="mb-6">
                      <p class="text-gray-700 font-bold">{college.name}</p>
                      <div class="flex justify-between flex-wrap gap-2 w-full">
                        ...
                        <p>
                          ...
                          <span class="text-gray-700">{college.time}</span>
                        </p>
                      </div>
                      <ul class="list-disc m-6">
